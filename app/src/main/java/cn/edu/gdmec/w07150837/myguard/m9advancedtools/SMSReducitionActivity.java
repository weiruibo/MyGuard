...
import cn.edu.gdmec.w07150837.myguard.m9advancedtools.utils.UIUtils;
import cn.edu.gdmec.w07150837.myguard.m9advancedtools.widget.MyCircleProgress;
...
/*public class SMSReducitionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initview();
        SmsReducitionUtils=new SmsReducitionUuils();
    }
    private void initview(){
        findViewById(R.id.rl_titleebar).setBackgroundColor(
        ...
        switch (v.getId()){
            ...
            case R.id.mcp_reducition:
                ...
                new Thread(){
                    public void run(){
                        try{
                            smsReducitionUtils.reducitionSms(SMSReducitionActivity.this,new
                            SmsReducitionUtils.SmsRducitionCallBack(){
