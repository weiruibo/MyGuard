package cn.edu.gdmec.w07150837.myguard.m8trafficmonitor.db.dao;
...
import cn.edu.gdmec.w07150837.myguard.m8trafficmonitor.db.TrafficOpenHelper;
...
public class TrafficDao {
    ...
    public long getMoblieGPRS(String dataString) {
        ...
        long gprs = 0;
        Cursor cursor = db.rawQuery("select gprs from traffic where date=?", new
