package cn.edu.gdmec.w07150837.myguard.m3communicationguard.db.dao;
...
import cn.edu.gdmec.w07150837.myguard.m3communicationguard.db.BlackNumberOpenHelper;
...
public class BlackNumberDao {
    ...
    public boolean add(BlackContactInfo blackContactInfo){
        ...
        //values.put("name",blackContactInfo.contactName);------------------这里报错
    ...
    public  List<BlackContactInfo>getPageBlackNumber(int pagenumber,int pagesize){
        ...
        while(cursor.moveToNext()){
           ...
           //这里报错------- info.contactName = cursor.getString(2);
    ...
    public int getTotalNumber(){
        SQLiteDatabase db =blackNumberOpenHelper.getReadableDatabase();
        //Cursor cursor = db.query("select count(*) from blacknumber",null,null,null,null);
       // cursor.moveToNext();
      // int count = cursor.getInt(0);
       // cursor.close();
        db.close();
        return 1; // 这句才是截图代码return count;
    }
}
